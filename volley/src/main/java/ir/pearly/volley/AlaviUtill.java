...
public class AlaviUtill {
    ...
    public static List<Integer> inputMultiList(final Context context, List item, Object title, String Positive, String Negative, boolean celable) {
    ...
    public static int inputList(final Context context, List item, Object title, int checkItem, boolean celable) {
